    ...
    pub fn tick(&mut self) {
        if self.hardware.regs().cpu_action_ready() {
            ...
            match self.read_next::<u8>() {
                ...
                0x96 => index_size!(self, store, IndexX, MemoryDirectPageIndexedX),
                ...
                0xB6 => index_size!(self, load, IndexX, MemoryDirectPageIndexedX),
                ...
                0xBE => index_size!(self, load, IndexX, MemoryAbsoluteIndexedX),
